/*
  # Update fish store schema and policies
  ...
  1. Changes
    ...
    - Add policy for admin price updates

  2. Security
    - Enable RLS on fish_data
    - Add policy for admin access
    - Add policy for public read access
    - Add specific policy for admin price updates
*/
...
BEGIN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'fish_data' AND policyname = 'admin_update_fish_prices'
  ) THEN

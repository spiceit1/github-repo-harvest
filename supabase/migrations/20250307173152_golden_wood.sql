/*
  # Add manual prices table with trigger
  ...
  2. Security
    ...
    - Add policy for admin users to manage manual prices using jwt() -> role check
...
-- Create policy using jwt() -> role check for admin access
